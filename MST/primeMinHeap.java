...
public class primeMinHeap {
    ...
    private static class Graph {
        ...
        private void addVertex(int dest) {
            map.put(dest, new LinkedList<Node>());
        }
...
*/
            while (!queue.isEmpty()) {
                ...
                for (Node adjancent : map.get(n.vertex)) {
                    if (!Mst[adjancent.dest] && edge[adjancent.dest].key >
                            adjancent.w) {
                        queue.remove(edge[adjancent.dest]);
                        edge[adjancent.dest].key = adjancent.w;
                        queue.add(edge[adjancent.dest]);
                        Parent[n.vertex] = adjancent.dest;
